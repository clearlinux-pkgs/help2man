...
Source0  : https://mirrors.kernel.org/gnu/help2man/help2man-1.47.17.tar.xz
Source1  : https://mirrors.kernel.org/gnu/help2man/help2man-1.47.17.tar.xz.sig
...
%prep
%setup -q -n help2man-1.47.17
cd %{_builddir}/help2man-1.47.17
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611070947
...
cp %{_builddir}/help2man-1.47.17/COPYING %{buildroot}/usr/share/package-licenses/help2man/31a3d460bb3c7d98845187c716a30db81c44b615
%make_install
